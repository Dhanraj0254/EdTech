        ...
        return(
            <div className='flex flex-col  lg:gap-3  ' key={index}>
              ...
              shadow-[#00000012] shadow-[0_0_62px_0]  '>
                ...
                {/* dot line*/}
                <div className={`hidden ${timeline.length-1===index?"hidden":"lg:block"} h-10  border-r
                 border-richblack-100 border-dotted bg-richblack-400/0 w-[26px]`}>
                 </div>
            </div>
...
<div className='absolute lg:left-[50%] lg:bottom-0 lg:translate-x-[-50%] lg:translate-y-[50%] bg-caribbeangreen-700 flex lg:flex-row flex-col
 text-white uppercase py-5 gap-4 lg:gap-0 lg:py-10'>
    <div className='flex gap-5 items-center border-r border-caribbeangreen-300 px-7 lg:px-14'>
        ...
        <p className='text-caribbeangreen-300 text-sm w-[75px]'>Years of Experince</p>
    </div>
