 ...
 const ExploreMore = () => {
  ...
  return (
    <div>
      ...
      <p className='text-center text-richblack-300 text-sm text-[16px] mt-3  '>
       ...
       {/* Tabs Section */}
      <div className=' hidden lg:flex  rounded-full bg-richblack-800 text-richblack-200
      font-medium drop-shadow- [0_1.5px_rgba(255,255,255,0.25)] mb-5 mt-5 p-1 gap-5 mx-auto w-max '>
        {
  ...
  return(
    ...
    onClick={()=>setMyCards(element)}>
      ...
      {/* Cards Section */}
      <div className=' lg:absolute gap-9 justify-center lg:gap-0 flex lg:justify-between
